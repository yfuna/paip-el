...
(ert-deftest test-paip-search ()
  ...
  (should (equal (paip-search-path-state
	   (paip-search-trip (paip-search-city 'San-Francisco) (paip-search-city 'Boston)))
	  '(BOSTON 71.05 42.21)))
  (should (equal (paip-search-path-state (trip (city 'boston) (city 'san-francisco)))
	  '(SAN-FRANCISCO 122.26 37.47)))
  (should (paip-search-trip (paip-search-city 'San-Francisco)
		     (paip-search-city 'Boston))
	  )
;;  (make-paip-search-path :state (paip-search-city 'San-Francisco))
