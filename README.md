...
This code is a port of the Common Lisp code found in the book [Paradigms of Artificial Intelligence Programming](http://norvig.com/paip.html), written by Peter Norvig. The goal of this project is to enable Emacs extension developers to use programming techniques in PAIP easily. The primary purpose of the project is not helping Emacs extention developers to understand the book but providing them with good modular software tools. If you would like to learn PAIP, I recommend you install [sbcl](http://www.sbcl.org/), a Common Lisp implementation, to run and hack the code by Norvig in Common Lisp.
