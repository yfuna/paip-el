...
|       - | [paip-tutor.el](https://github.com/yfuna/paip-el/blob/master/paip-tutor.el)       | Done  |      | An interpreter for running the examples                           |                     |
|       - | [paip.el](https://github.com/yfuna/paip-el/blob/master/paip.el)                   | Done  |      | Auxiliary functions; load this before anything else (auxfns.lisp) |                     |
|       - | [paipx.el](https://github.com/yfuna/paip-el/blob/master/paipx.el)                 | Done  |      | Additional auxiliary functions for EL port                        |                     |
|       1 | [paip-intro.el](https://github.com/yfuna/paip-el/blob/master/paip-intro.el)       | Done  |      | A few simple definitions                                          |                     |
|       2 | [paip-simple.el](https://github.com/yfuna/paip-el/blob/master/paip-simple.el)     | Done  |      | Random sentence generator (two versions)                          |                     |
|       3 | [paip-overview.el](https://github.com/yfuna/paip-el/blob/master/paip-overview.el) | Done  |      | 14 versions of LENGTH and other examples                          |                     |
|       4 | [paip-gps1.el](https://github.com/yfuna/paip-el/blob/master/paip-gps1.el)         | Done  |      | Simple version of General Problem Solver                          |                     |
|       4 | [paip-gps.el](https://github.com/yfuna/paip-el/blob/master/paip-gps.el)           | Done  |      | Final version of General Problem Solver                           |                     |
|       5 | [paip-eliza1.el](https://github.com/yfuna/paip-el/blob/master/paip-eliza1.el)     | Done  |      | Basic version of Eliza program                                    |                     |
|       5 | [paip-eliza.el](https://github.com/yfuna/paip-el/blob/master/paip-eliza.el)       | Done  |      | Eliza with more rules; different reader                           |                     |
|       6 | [paip-patmatch.el](https://github.com/yfuna/paip-el/blob/master/paip-patmatch.el) | Done  |      | Pattern Matching Utility                                          |                     |
|       6 | [paip-eliza-pm.el](https://github.com/yfuna/paip-el/blob/master/paip-eliza-pm.el) | Done  |      | Version of Eliza using utilities                                  |                     |
|       6 | [paip-search.el](https://github.com/yfuna/paip-el/blob/master/paip-search.el)     | Done  |      | Search Utility                                                    |                     |
|       6 | [paip-gps-srch.el](https://github.com/yfuna/paip-el/blob/master/paip-srch.el)     | Done  |      | Version of GPS using the search utility                           |                     |
|       7 | [paip-student.el](https://github.com/yfuna/paip-el/blob/master/paip-student.el)   | Done  |      | The Student Program                                               |                     |
|       8 | [paip-macsyma.el](https://github.com/yfuna/paip-el/blob/master/paip-macsyma.el)   | Done  |      | The Macsyma Program                                               |                     |
|       8 | [paip-macsymar.el](https://github.com/yfuna/paip-el/blob/master/paip-macsymar.el) | Done  |      | Simplification and integration rules for Macsyma                  |                     |
|    9-10 |                                                                                   |       |      | no files; important functions in auxfns.el                        |                     |
|      11 | [paip-unify.el](https://github.com/yfuna/paip-el/blob/master/paip-unify.el)       | Done  |      | Unification functions                                             |                     |
|      11 | [paip-prolog1.el](https://github.com/yfuna/paip-el/blob/master/paip-prolog1.el)   | Done  |      | First version of Prolog interpreter                               |                     |
|      11 | [paip-prolog.el](https://github.com/yfuna/paip-el/blob/master/paip-prolog.el)     | Done  |      | Final version of Prolog interpreter                               |                     |
|      12 | paip-prologc1.el                                                                  | Won't |      | First version of Prolog compiler                                  |                     |
|      12 | paip-prologc2.el                                                                  | Won't |      | Second version of Prolog compiler                                 |                     |
|      12 | [paip-prologc.el](https://github.com/yfuna/paip-el/blob/master/paip-prologc.el)   | Done  |      | Final version of Prolog compiler                                  |                     |
|      12 | [paip-prologcp.el](https://github.com/yfuna/paip-el/blob/master/paip-prologcp.el) | Done  |      | Primitives for Prolog compiler                                    |                     |
