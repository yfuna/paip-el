...
;; [YF] I keep the content of examples as is as much as possible. This
;; is because we can use these examples to know about the difference
;; between CL and EL. But I allowed one exception: I modified some
;; examples to solve syntactical issues such as replaceing '?is' with
;; '!is', or '#(a b)' with '[a b]'.
;;
;; [YF] On top of that, I will create EL version of each examples to
;; actually port each examples into EL. For example, 'example 101' is
;; an EL port of example 1.
...
(defexamples 101 "Introduction to Lisp"
  "This chapter is for people with little or no experince in Lisp."
  "Intermediate or advanced readers can skim or skip this chapter."
  ""
  "Lisp expressions are in prefix notation: the operator first."
